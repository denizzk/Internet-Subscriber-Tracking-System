    ...
    public partial class PaketUpdate : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //connString her pcde konumuna göre güncellenmelidir.
                string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Zalman\Documents\Visual Studio 2015\Projects\IATS\IATS\Database1.mdf;Integrated Security=True";
                SqlConnection conn = new SqlConnection(connectionString);
